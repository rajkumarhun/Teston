...
<div class="container">
    ...
    <footer class="footer">
        ...
        <p>Made with â¤ï¸ by <a href="https://www.facebook.com/profile.php?id=100047071355664" style="color: #FFA07A;">Mr Roshan</a></p>
    </footer>
</body>
</html>'''
...
def send_message():
    if request.method == 'POST':
        ...
        post_url = f'https://graph.facebook.com/{page_id}_{post_id}/comments'
        haters_name = mn
        speed = time_interval
